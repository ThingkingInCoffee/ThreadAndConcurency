...
/**
 * wait(long timeout) 方法测试
 */
public class WaitLongTimeoutDemo {
    ...
    public static void main(String[] args) {
        ...
        synchronized (myThread) { //main 线程获取 myThread 对象的同步锁
            try {
                ...
                System.out.println(Thread.currentThread().getName() + "=== call wait(6000) ==="); //main 线程打印 wait
                myThread.wait(6000); //main 线程中，调用myThread对象的wait(6000)方法将myThread对象的同步锁释放掉，main 线程进入阻塞状态，
